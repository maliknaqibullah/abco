<div>
@push('pagetitle', 'Permissions')
    <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6 mb-5">
        <div class="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
            <div class="ml-4 mt-2">
                <h3 class="text-lg leading-6 font-medium text-gray-900"> Add Permission</h3>
            </div>
    ...
    <x-jet-action-message class="mr-3" on="saved">
        {{ __('Permission Published Successfully.') }}
    ...
    <x-jet-dialog-modal wire:model="isOpen">
        <x-slot name="title">
            {{ __('Add AddPermission') }}
        </x-slot>

        <x-slot name="content">
            <div class="intro-y box p-5">
                <form wire:submit.prevent="savePermission" class="pb-10 ">
        ...
        <x-slot name="footer">
            ...
            <x-jet-button class="ml-3" wire:click.prevent="savePermission" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
    ...
    <x-jet-dialog-modal wire:model="confirmDeletion">
        ...
        <x-slot name="content">
            {{ __('Are you sure you want to delete Permission? Once Permission is deleted, all of its resources and data will be permanently deleted. ') }}
